...
from mindspeed.mindspore.core.transformer.moe.grouped_mlp_with_comp_and_comm_overlap_all2all import grouped_mlp_with_comp_and_comm_overlap_all2all
    ...
    if not is_recompute_activation:
        if permuted_local_hidden_states.nelement() != 0:
            ...
            if args.moe_bmm_mc2:
                ...
                fc1_output = gg.gmm(permuted_local_hidden_states, w1, tokens_per_expert, trans_b=False,
