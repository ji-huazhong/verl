...
common_params=(
    ...
    actor_rollout_ref.actor.veomni.offload.param=${OFFLOAD_TARGET} \
    actor_rollout_ref.actor.veomni.offload.optimizer=${OFFLOAD_TARGET} \
    ...
    actor_rollout_ref.ref.veomni.offload.param=${OFFLOAD_TARGET} \
