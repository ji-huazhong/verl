...
"${LAUNCH[@]}" -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.actor.fsdp_config.offload.param=${OFFLOAD_TARGET} \
    actor_rollout_ref.actor.fsdp_config.offload.optimizer=${OPTIMIZER_OFFLOAD_TARGET} \
    ...
    actor_rollout_ref.ref.fsdp_config.offload.param="${OFFLOAD_TARGET}" \
    ...
    critic.fsdp.offload.param=${OFFLOAD_TARGET} \
    critic.fsdp.offload.optimizer=${OPTIMIZER_OFFLOAD_TARGET} \
