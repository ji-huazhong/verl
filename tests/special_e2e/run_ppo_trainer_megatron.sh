...
common_params=(
    ...
    actor_rollout_ref.actor.megatron.offload.param=${OFFLOAD_TARGET}
    actor_rollout_ref.actor.megatron.offload.optimizer=${OFFLOAD_TARGET}
    ...
    actor_rollout_ref.ref.megatron.offload.param=${OFFLOAD_TARGET}
    ...
    critic.megatron.offload.param=${OFFLOAD_TARGET}
    critic.megatron.offload.optimizer=${OFFLOAD_TARGET}
