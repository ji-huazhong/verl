...
class MegatronSFTTrainer:
    def __init__(
        ...
        self.rank = torch.disbributed.get_rank()
    ...
    def _build_model_optimizer(self, model_path, optim_config, override_model_config, override_transformer_config):
        ...
        def make_model(wrap_with_ddp=False):
            if self.bridge is not None:
                ...
                if override_model_config.get("moe_config", {}).get("freeze_router", False):
        ...
        model_module = make_model(wrap_with_ddp=True)
    ...
    def init_model(self):
        ...
        self.dtype = PrecisionType.to_dtype(param_dtype)
        ...
        self.checkpoint_manager = MegatronCheckpointManager(
            ...
            use_distributed_optimizer=self.config.megatron.use_distributed_optimizer,
            use_checkpoint_opt_param_scheduler=self.config.megatron.use_checkpoint_opt_param_scheduler,
            bridge=self.bridge,
