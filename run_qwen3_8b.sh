...
export PYTHONPATH=/home/lynn/offload/Megatron-LM:$PYTHONPATH

# Project Configuration
project_name='GRPO-Qwen3-8B'
exp_name='GRPO-Qwen3-8B-Megatron-vLLM'
...
# Model Weights Paths
MODEL_PATH=/home/lynn/model/Qwen3-8B

CKPTS_DIR=${CKPTS_DIR:-"/home/lynn/offload/ckpts/${project_name}/${exp_name}"}

# File System Paths
TRAIN_FILE=/home/lynn/data/gsm8k/train.parquet
TEST_FILE=/home/lynn/data/gsm8k/test.parquet
...
ACTOR_CONFIG=(
    ...
    actor_rollout_ref.actor.megatron.nccl_offload=True
