...
After all three runs have reached the same final step, use the optional
[curve export script](https://github.com/ji-huazhong/mlsys-notes/blob/main/rl/qat/export_int4_qat_three_way_curves.py)
in the [experiment archive](https://github.com/ji-huazhong/mlsys-notes/tree/main/rl/qat)
to export JSON, CSV, and a three-panel PNG. Usage is documented in the archive
README. This offline analysis tool is independent of QAT training and weight
updates.
